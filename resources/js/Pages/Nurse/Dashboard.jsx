...
import {
    ...
    faUsers, faUserDoctor, faVenus, faShieldAlt, faCalendarAlt
                    ...
                    <div className="md:col-span-1 space-y-6">
                        ...
                        <div className="bg-office-colorful-surface shadow-sm sm:rounded-lg p-4 border border-office-colorful-border dark:bg-office-black-surface dark:border-office-black-border">
                            ...
                            <div className="flex flex-col space-y-2">
                                <Link href={route('profile.edit')} className="text-sm text-office-colorful-subtext hover:text-office-colorful-ribbon dark:text-office-black-subtext dark:hover:text-office-accent transition flex items-center">
                                    <FontAwesomeIcon icon={faUser} className="mr-2 w-4" /> Profile Info
                                </Link>
                                <Link href={route('nurse.users.index')} className="text-sm text-office-colorful-subtext hover:text-office-colorful-ribbon dark:text-office-black-subtext dark:hover:text-office-accent transition flex items-center">
                        ...
                        <div className="bg-office-colorful-surface shadow-sm sm:rounded-lg p-4 border border-office-colorful-border dark:bg-office-black-surface dark:border-office-black-border">
                            ...
                            <div className="flex flex-col space-y-2">
                                <Link href={route('nurse.users.index', { role: 'mother' })} className="text-sm text-office-colorful-subtext hover:text-office-colorful-ribbon dark:text-office-black-subtext dark:hover:text-office-accent transition flex items-center">
                                    <FontAwesomeIcon icon={faVenus} className="mr-2 w-4" /> All Mothers
                                </Link>
                    ...
                    <div className="md:col-span-3">
                        ...
                        <div className="bg-office-colorful-surface overflow-hidden shadow-sm sm:rounded-lg p-6 border border-office-colorful-border dark:bg-office-black-surface dark:border-office-black-border">
                            ...
                            <div className="flex gap-4">
                                ...
                                <Link
                                    href={route('nurse.announcements.create')}
                                    className="px-4 py-2 bg-office-colorful-bg text-office-colorful-text rounded-md hover:bg-office-colorful-border transition dark:bg-office-black-bg dark:text-office-black-text dark:hover:bg-office-black-border"
                                >
                                    Create Announcement
                                </Link>
                            </div>
