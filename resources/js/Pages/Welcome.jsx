...
export default function Welcome({ auth }) {
    return (
        <div className="min-h-screen bg-office-colorful-bg dark:bg-office-black-bg text-office-colorful-text dark:text-office-black-text selection:bg-office-colorful-ribbon selection:text-white bg-wave-container">
            ...
            <Head title="Welcome to BCS Modern" />
            ...
            <footer className="border-t border-office-colorful-border dark:border-office-black-border py-12 bg-office-colorful-surface dark:bg-office-black-surface mt-24">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <p className="text-office-colorful-subtext dark:text-office-black-subtext text-sm">
                        &copy; {new Date().getFullYear()} BCS Modern Healthcare Platform. All rights reserved.
                    </p>
                </div>
            </footer>
            </div>
